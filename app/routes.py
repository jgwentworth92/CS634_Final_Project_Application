...
bp.add_url_rule('/revenue_by_facility/<date>', view_func=facility.revenue_by_facility, methods=['GET', 'POST'])
bp.add_url_rule('/top_revenue_days/<monthyear>', view_func=appointment_management.top_revenue_days, methods=['GET', 'POST'])
bp.add_url_rule('/average_revenue/<beginandend_datevalue>', view_func=appointment_management.average_revenue, methods=['GET', 'POST'])
